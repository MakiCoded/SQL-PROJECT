...
INSERT INTO PRODUCTS 
VALUES 
(16, 'Ayomide OJo', 8, 9, '21 boxes (1 kg)', 195.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(18, 'Macdonald Osakwe', 8, 9, '22 boxes (5 kg)', 185.00, 0, 0, -1);
INSERT INTO PRODUCTS 
VALUES 
(24, 'Maryam Datti', 7, 8, '20 boxes (2 kg)', 175.00, 0, 0, -1);
INSERT INTO PRODUCTS 
VALUES 
(26, 'Kester Eze', 9, 8, '10 boxes (1 kg)', 165.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(27, 'Amaka Opala', 4, 5, '15 boxes (3 kg)', 205.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(29, 'Kabiru Abdul', 6, 7, '30 boxes (4 kg)', 225.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(33, 'Eno Eze', 8, 9, '40 boxes (4 kg)', 245.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(38, 'Saratu Datti', 7, 9, '45 boxes (5 kg)', 255.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(41, 'Aisha Datti', 8, 9, '50 boxes (5 kg)', 265.00, 0, 0, -1);


INSERT INTO PRODUCTS 
VALUES 
(44, 'Seun Ojo', 7, 7, '20 boxes (2 kg)', 170.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(45, 'Peter Obi', 2, 4, '5 boxes (1 kg)', 150.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(47, 'Bola Tinubu', 7, 9, '100 boxes (10 kg)', 300.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(48, 'Muhammed Buhari', 4, 5, '50 boxes (10 kg)', 250.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(50, 'Kashim Shettima ', 8, 9, '200 boxes (20 kg)', 350.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(58, 'Elon Musk', 7, 7, '500 boxes (100 kg)', 550.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(54, 'Alico Dangote', 5, 9, '50 boxes (5 kg)', 250.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(57, 'Olusegun Obasanjo', 7, 9, '100 boxes (50 kg)', 350.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(61, 'Bill Gate ', 7, 9, '150 boxes (150 kg)', 400.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(62, 'Jeff Bezos', 7, 8, '150 boxes (150 kg)', 400.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(63, 'Adaeze Osakwe ', 9, 9, '10 boxes (10 kg)', 200.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(64, 'King Solomon', 9, 9, '1000 boxes (1000 kg)', 400.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(65, 'Hanatu Datti', 6, 7, '10 boxes (10 kg)', 200.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(68, 'Ehis Omo', 8, 9, '2 boxes (2 kg)', 185.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(71, 'Salamatu Baraya', 7, 8, '20 boxes (20 kg)', 205.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(75, 'Cynthia Aduga', 8, 9, '20 boxes (20 kg)', 205.00, 0, 0, -1);


INSERT INTO PRODUCTS 
VALUES 
(90, 'Marshall Mathers', 6, 7, '20 boxes (40 kg)', 200.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(91, 'Hailie Jade', 7, 8, '33 boxes (33 kg)', 233.00, 0, 0, -1);

INSERT INTO PRODUCTS 
VALUES 
(92, 'Sophia Hassan', 8, 9, '53 boxes (53 kg)', 253.00, 0, 0, -1);
...
---(using LPAD or RPAD for formatting), Age, and Seniority.
...
SELECT 
    ...
    (CURRENT_DATE - HIRE_DATE)::INTEGER AS SENIORITY 
FROM 
    EMPLOYEES
WHERE 
    TITLE = 'Mr.'  -- Filter for male employees
...
SELECT PRODUCT_REF, PRODUCT_NAME, SUPPLIER_NUMBER, UNITS_ON_ORDER, UNIT_PRICE FROM PRODUCTS
WHERE 
...
---(unit price * quantity) is between 0 and 2000, 5% if between 2001 and 10000, 10% if between 10001 and 40000, 15% if between 40001 and 80000, and 20% otherwise.
...
WHERE 
    c.CITY = 'Berlin'
    AND (p.CATEGORY_CODE = '3' OR p.CATEGORY_CODE IS NULL)
GROUP BY 
    c.CUSTOMER_CODE
HAVING 
    COUNT(p.CATEGORY_CODE = '3' OR NULL) <= 1;
...
LEFT JOIN
    ...
    AND o.ORDER_DATE BETWEEN '01-04-1998' AND '30-04-1998'
    AND EXTRACT(DOW FROM o.ORDER_DATE) = 1  -- 1 represents Monday
WHERE
    c.COUNTRY = 'France'
GROUP BY
...
HAVING
    COUNT(DISTINCT p.PRODUCT_REF) = (SELECT COUNT(*) FROM PRODUCTS)
ORDER BY
    c.CUSTOMER_CODE;
...
---and the difference between these two numbers. The resulting table should display the 
---columns: orders in 1996, orders in 1997, and Difference.

 SELECT
    COUNT(CASE WHEN EXTRACT(YEAR FROM ORDER_DATE) = 1996 THEN 1 END) AS "Orders in 1996",
    COUNT(CASE WHEN EXTRACT(YEAR FROM ORDER_DATE) = 1997 THEN 1 END) AS "Orders in 1997",
    COUNT(CASE WHEN EXTRACT(YEAR FROM ORDER_DATE) = 1997 THEN 1 END) - 
